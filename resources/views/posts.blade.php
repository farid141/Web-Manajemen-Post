        ...
        @if ($posts->count())
            <div class="card mb-3">
                ...
                <div class="card-body text-center">
                    ...
                    <a href="/posts/{{ $posts[0]->slug}}" class="text-decoration-none btn">more</a>
                </div>
            </div> 
                    ...
                    @foreach ($posts->skip(1) as $post)
                        <div class="col-md-4">
                            <div class="card">
                                ...
                                <div class="position-absolute px-3 py-2 text-white" style="background-color: rgba(0, 0, 0, 0.7)"><a href="/categories/{{ $post->category->slug }}" class="text-white text-decoration-none">{{ $post->category->name }}</div></a>
